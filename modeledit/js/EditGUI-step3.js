...
(function anonymous(
  ...
  function _$af1462855() {
    ...
    var snapFlash = function() {
      var flash = dom.cla("snapshotFlash", fdageUI)[0];
      dom.addClass(dom.cla("snapshot", fdageUI)[0], "unable");
    ...
    var snapshot = function() {
      ...
      setTimeout(function() {
        ...
        if (auto) {
          setTimeout(function() {
            dom.removeClass(dom.cla("snapshot", fdageUI)[0], "unable")
          }, 1000)
        };
    ...
    _this.setSnapshot = function() {
      var fdageUI = dom.id("fdageUI");
      var btn = document.createElement("div");
      fdageUI.appendChild(btn);
    ...
    function save() {
      ...
      var callback = function() {
        ...
        var eventFun = function() {
          ...
          _this.progressFun(dom.id("fdageUI"), progressRate)
        };
        ...
        $.ajax({
          ...
          success: function(data) {
            if (data === 0) {
              ...
              _this.progressFun(dom.id("fdageUI"), 100, function() {
