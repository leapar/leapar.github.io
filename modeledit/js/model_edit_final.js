...
(function anonymous( /*``*/ ) {
  ...
  embed = function(a, b) {
    ...
    if (b.pagePreset) {
      ...
      if (jmyd.edit) {
        ...
        c = new WebViewer(b.fullFrame ? p.clientWidth : b.width, b.fullFrame ? p.clientHeight : b.height, a, !!d), webview = c, p.appendChild(c.domRoot)
      } else {
        c = new WebViewer(b.fullFrame ? window.innerWidth : b.width, b.fullFrame ? window.innerHeight : b.height, a, !!d), document.body.appendChild(c.domRoot)
      }
    };
        ...
        if (f.pressed) {
          ...
          if (gui && gui.drawRect) {
            ...
            if (!webview.scene.rect) {
              new Rect(webview.gl, x, y, we, hi, [1, 0, 0, 1])
            } else {
  ...
  TranslateCon = function(position, object, length) {
    this.gl = webview.gl;
    this.visible = true;
    ...
    for (var i in this.axis) {
      this.axis[i].cone = new Cone(0.4, 1.309, i, this.axisLength, position);
  ...
  TranslateCon.prototype.createLine = function(length, axis, color, position) {
    var points = [
      [0, 0, 0],
      [0, length, 0]
    ];
    ...
    return new Line(webview.gl, null, points[0], points[1], color, 0, 0, 0)
  }
  TranslateCon.prototype.draw = function(matrixWeight) {
    var b = this.gl;
  ...
  TranslateCon.prototype.setSelectColor = function() {
    for (var i in this.axis) {
      for (var j = 0; j < 3; j++) {
  ...
  TranslateCon.prototype.changePosition = function(pos, transMatrix) {
  ...
  preTransform = function(points, o) {
  ...
  getScaleMatrix = function(pos, matrixWeight) {
    var r = 0.05;
    var pos = pos.slice(0);
  ...
  Cone = function(h, angle, axis, len, position) {
    this.gl = webview.gl;
  ...
  Cone.prototype.updateVertexBuffer = function() {
    var a = [];
    for (var i = 0; i < this.points.length; i++) {
  ...
  LightTargetCon = function(direction, position, object, length) {
    this.gl = webview.gl;
    this.visible = true;
    ...
    this.line = new Line(webview.gl, null, this.position, this.position2, this.color, 0, 0, 0);
    this.sphere = new Sphere(this.position2, this);
    this.shader = this.gl.shaderCache.fromURLs("standardvert.glsl", "standardfrag.glsl");
    this.tranCon = new TranslateCon(this.position2, this.sphere, 1.2);
    this.tranCon.visible = false
  }
  LightTargetCon.prototype.getPos2ByDir = function() {
  ...
  LightTargetCon.prototype.draw = function() {
    var b = this.gl;
    b.enable(b.CULL_FACE), b.cullFace(b.BACK);
    b.enable(b.BLEND);
    b.blendFuncSeparate(b.SRC_ALPHA, b.ONE_MINUS_SRC_ALPHA, b.ONE_MINUS_DST_ALPHA, b.ONE);
  ...
  LightTargetCon.prototype.changePosition = function(pos, tranM, type) {
  ...
  Sphere = function(position, object) {
  ...
  Sphere.prototype.updateVertexBuffer = function() {
    var a = [];
    for (var i = 0; i < this.points.length; i++) {
      a = a.concat(this.points[i])
    };
  ...
  Sphere.prototype.isClicked = function(x, y) {
    var w = 12;
  ...
  lightSi = function(a, index) {
    ...
    this.sprite = new Sprite("light" + index, "images/" + textures[this.type] + ".png", this.realPosition, this.color, 1, 1, this);
    if (this.on) {
      this.setSpriteColor()
    } else {
    ...
    this.targetCon = new LightTargetCon(this.direction, this.position, this, 7);
    if (!this.on) {
      this.targetCon.color[0] = 0, this.targetCon.color[1] = 0, this.targetCon.color[2] = 0
    };
    this.tranCon = new TranslateCon(this.position, this, 2);
    this.guide = new GuideLine()
  }
  lightSi.prototype.preDealColor = function() {
  ...
  lightSi.prototype.setSpriteColor = function(dealColor) {
    var color = [];
  ...
  lightSi.prototype.setDisplay = function(o) {
    for (var i in o) {
      if (i == "guide") {
  ...
  lightSi.prototype.recognizeType = function() {
  ...
  lightSi.prototype.getAngle = function() {
    return this.spot[0]
  }
  lightSi.prototype.setAngle = function(angle) {
    this.spot[0] = angle;
    this.spot[2] = (13131.2211 / (angle * angle) + 0.3788616) * this.spot[1];
    this.angle = angle
  }
  lightSi.prototype.getSharpness = function() {
    return this.spot[1]
  }
  lightSi.prototype.setSharpness = function(sharp) {
    this.spot[1] = sharp;
    var a = this.spot[0];
    this.spot[2] = (13131.2211 / (a * a) + 0.3788616) * sharp;
    this.sharpness = sharp
  }
  lightSi.prototype.getDistance = function() {
    return 0.05 / this.parameter[2]
  }
  lightSi.prototype.setDistance = function(dis) {
    this.parameter[2] = 0.05 / dis;
    this.distance = dis
  }
  lightSi.prototype.getCurve = function() {
    return this.parameter[0] / (-2)
  }
  lightSi.prototype.setCurve = function(curve) {
    this.parameter[0] = -2 * curve;
    this.parameter[1] = 2 * curve - 1
  }
  lightSi.prototype.translate = function(axis, len, type) {
    if (type === "lightTransLine") {
  ...
  Lights = function(a, b) {
    ...
    for (var i = 0; i < this.maxCount; i++) {
      this.lights.push(new lightSi(a, i))
    };
    this.order = [];
    this.tidyOrder()
  }
  Lights.prototype.getIndex = function(index) {
    for (var i = 0; i < this.maxCount; i++) {
  ...
  Lights.prototype.changeColor = function(index) {
  ...
  Lights.prototype.changeParameter = function(index) {
    var i = this.getIndex(index);
  ...
  Lights.prototype.changeSpot = function(index) {
    var i = this.getIndex(index);
  ...
  Lights.prototype.changePosition = function(index) {
    var i = this.getIndex(index);
  ...
  Lights.prototype.changeDirection = function(index) {
    var i = this.getIndex(index);
  ...
  Lights.prototype.changeMatrixWeight = function(index) {
    var i = this.getIndex(index);
    this.matrixWeights[i] = this.lights[index].matrixWeight
  }
  Lights.prototype.reBuildPorp = function() {
  ...
  Lights.prototype.tidyOrder = function() {
    var onAndShadow = [];
    var on = [];
    var off = [];
    this.count = 0;
  ...
  Material.prototype.addOrRemoveDefine = function(define, state) {
    var e = this.defines;
    if (state) {
  ...
  Material.prototype.changeDefine = function(def) {
    var e = this.defines;
  ...
  Matrix.create = function(a, b, c, d, e, f, g, h, k, l, m, n, r, p, q, u) {
  ...
  Matrix.set = function(a, b, c, d, e, f, g, h, k, l, m, n, r, p, q, u, s) {
    a[0] = b;
    a[4] = c;
    a[8] = d;
    a[12] = e;
  ...
  Matrix.translation = function(a, b, c, d) {
    Matrix["set"](a, 1, 0, 0, b, 0, 1, 0, c, 0, 0, 1, d, 0, 0, 0, 1);
    return a
  }
  Matrix.rotation = function(a, b, c) {
    a[0] = 1;
    a[4] = 0;
    a[8] = 0;
    a[12] = 0;
  ...
  Matrix.mul4 = function(a, b, c, d, e, f) {
  ...
  Matrix.perspectiveInfinite = function(a, b, c, d, e) {
    e = e || 0;
    b = 1 / Math.tan(0.00872664625 * b);
    a[0] = b / c;
    a[1] = a[2] = a[3] = 0;
  ...
  Matrix.ortho = function(a, b, c, d, e, f, g, h) {
    var k = 1 / (c - b),
      l = 1 / (e - d),
      m = 1 / (g - f);
    a[0] = k + k;
  ...
  Matrix.lookAt = function(a, b, c, d) {
  ...
  Matrix.copy = function(a, b) {
    for (var c = 0; 16 > c; ++c) {
      a[c] = b[c]
    }
  }
  Matrix.copyToBuffer = function(a, b, c) {
    for (var d = 0; 16 > d; ++d) {
      a[b + d] = c[d]
    }
  }
  ...
  Sprite = function(name, imgUrl, position, color, scale, visible, object) {
    this.name = name;
    this.imgUrl = imgUrl;
    this.prepareTexture();
    this.gl = webview.gl;
  ...
  turn3dTo2d = function(pos3d, matrix) {
  ...
  Sprite.prototype.changePosition = function(pos) {
    this.position = pos.slice(0, 3)
  }
  Sprite.prototype.isClicked = function(x, y) {
  ...
  Sprite.prototype.changeTexture = function(imgUrl) {
    this.imgUrl = imgUrl;
    this.prepareTexture()
  }
  Sprite.prototype.prepareTexture = function() {
  ...
  Sprite.prototype.complete = function() {
    return this.shader.complete() && this.texture && this.texture.complete()
  }
  Rect = function(a, x, y, w, h, color) {
    this.gl = a;
    this.shader = new Shader(a);
  ...
  Rect.prototype.update = function(x, y, w, h) {
    var a = this.gl;
    this.x1 = x;
    this.y1 = y;
    this.x2 = x + w;
  ...
  SnapshotLine.prototype.update = function() {
    var a = this.gl;
    var margin = 1;
  ...
  SnapshotLine.prototype.draw = function() {
    if (this.alpha < 1) {
      this.alpha += 0.1
    };
    var b = webview.gl;
  ...
  Line = function(a, s, p1, p2, color, height, noPivot) {
    this.gl = a;
  ...
  Line.prototype.updateVertexBuffer = function() {
    var a = this.gl;
    a.bindBuffer(a.ARRAY_BUFFER, this.vertexBuffer);
    a.bufferData(a.ARRAY_BUFFER, new Float32Array(this.position), a.STATIC_DRAW);
    a.bindBuffer(a.ARRAY_BUFFER, null)
  }
  Line.prototype.isHover = function(x, y, canvasW, canvasH) {
    if (!this.lineMatrix) {
      return
    };
  ...
  Line.prototype.draw = function(s, matrix, alpha) {
    var b = this.gl;
    this.shader.bind();
    b.enable(b.BLEND);
    b.blendFuncSeparate(b.SRC_ALPHA, b.ONE_MINUS_SRC_ALPHA, b.ONE_MINUS_DST_ALPHA, b.ONE);
  ...
  Mesh.prototype.rebuildAlpha = function(a) {
  ...
  Mesh.prototype.rebuildNormal = function(a, o) {
    if (o.smooth) {};
    var alphaArray = this.meshAlphaBuffer[this.meshAlphaBuffer.length - 1];
    var c1 = [];
    c1[0] = this.vertexUint8[0];
  ...
  MeshRenderable.prototype.computeBoundingSphere = function(b) {
    var signal = dom.id("signalText", jmydUI);
    if (!signal) {
      signal = document.createElement("div");
      signal.id = "signalText";
      jmydUI.appendChild(signal);
  ...
  MeshRenderable.prototype.draw = function(s) {
    var b = this.gl;
  ...
  MeshRenderable.prototype.drawHighlight = function(a, offset, alpha) {
    var b = this.gl;
  ...
  Network.fetchImage = function(a, b, c) {
    var d = new Image;
  ...
  Network.fetchText = function(a, b, c, d) {
  ...
  Network.fetchBinary = function(a, b, c, d, o) {
    var e = new XMLHttpRequest;
    e.open("GET", a, !0);
  ...
  Network.fetchBinaryIncremental = function(a, b, c, d) {
    var e = new XMLHttpRequest;
    e.open("HEAD", a, !0);
    e.onload = function() {
      if (200 == e.status) {
  ...
  Shader.prototype.build = function(a, b, name) {
    var c = this.gl;
    ...
    c.shaderSource(e, a);
    c.compileShader(e);
    c.getShaderParameter(e, c.COMPILE_STATUS) || (console.log(this.name + c.getShaderInfoLog(e)), jmyd.verboseErrors && d(a));
    c.attachShader(this.program, e);
    e = c.createShader(c.FRAGMENT_SHADER);
    c.shaderSource(e, b);
    c.compileShader(e);
    c.getShaderParameter(e, c.COMPILE_STATUS) || (console.log(this.name + c.getShaderInfoLog(e)), jmyd.verboseErrors && d(b));
    c.attachShader(this.program, e);
  ...
  Sky.prototype.draw = function(a) {
    if (1 > this.backgroundMode || jmyd.transparentBackground) {
      return !1
    };
    if (this.complete()) {
      var b = this.gl,
  ...
  TextureCache.prototype.fromFile = function(a, b, f2, f1, v) {
    if (!a) {
      return null
    };
  ...
  TextureCache.prototype.fromFilesMergeAlpha2 = function(a, b, c, mat) {
    if (!b) {
      return this.fromFile(a, c)
    };
    var d = a.name + "|" + b.name,
  ...
  TextureCache.prototype.MergeAlpha = function(a, b, c) {
    if (!b) {
      return a
    };
    var f = this.gl;
  ...
  TextureCache.prototype.MergeAlpha2 = function(a, b, c, unmerge, n1, n2, mat) {
    var _this = this;
    ...
    if (!b || b instanceof Texture && b.desc.width === 1 && b.desc.height === 1) {
      if (unmerge) {
        if (!b && n2) {
      ...
      n = function() {
        if (j && k) {
          if (j instanceof Image) {
            j1 = new Texture(f), j1.loadImage(j, f.RGB), j = j1
          };
          if (k instanceof Image) {
            k1 = new Texture(f), k1.loadImage(k, f.RGB), k = k1
          };
          ...
          if (w <= f.limits.viewportSizes[0] && h <= f.limits.viewportSizes[1]) {
            ...
            unmerge && n1 && n2 && (unmerge[n1].tex = j, unmerge[n2].tex = k), Framebuffer.bindNone(f), g.rebuildMips()
          } else {
            console.error("\u8d34\u56fe\u5bbd\u6216\u957f\u5927\u4e8e16384\uff0c\u65e0\u6cd5\u5408\u5e76");
            var c = document.createElement("canvas");
            c.width = w;
    ...
    if (!(a instanceof Texture)) {
      TextureCache.parseFile(a, function(aa) {
        if (aa.width === 1 && aa.height === 1) {
          var value = getValue(aa);
          if (unmerge && n1) {
    ...
    if (!(b instanceof Texture)) {
      TextureCache.parseFile(b, function(bb) {
  ...
  UI.prototype.showFailure = function(info) {
  ...
  UI.prototype.showPreview = function() {
    ...
    this.playButton.src = jmyd.dataLocale + "play.png";
  ...
  UI.prototype.showActiveView = function() {
    ...
    void(0) === jmyd.largeUI && (jmyd.largeUI = this.viewer.mobile);
    450 > this.container.width && (jmyd.largeUI = !1);
    var b = FullScreen.support(),
      a = 1;
    window.devicePixelRatio && (2 < window.devicePixelRatio ? a = 4 : 1 < window.devicePixelRatio && (a = 2));
    jmyd.largeUI && 4 > a && (a *= 2);
    var c = jmyd.largeUI ? 0.3 : 0.5;
    ...
    h.style.position = "absolute";
    h.style["z-index"] = "20";
    h.style.right = jmyd.largeUI ? "85px" : "45px";
    h.style.top = jmyd.largeUI ? "20px" : "12px";
    h.style.width = e + "px";
    h.style.height = f + "px";
    ...
    f.style.border = "0px";
    f.style.outline = "0px";
    f.style.fontSize = jmyd.largeUI ? "16pt" : "10pt";
    f.style.right = jmyd.largeUI ? "-9px" : "4px";
    f.style.top = jmyd.largeUI ? "3px" : "7px";
    f.style.width = f.style.height = jmyd.largeUI ? "32px" : "16px";
    ...
    f.src = jmyd.dataLocale + "helprotate" + g;
    f.style.width = "66px";
    f.style.height = "90px";
    h.appendChild(f);
    f = document.createElement("img");
    f.src = jmyd.dataLocale + "helpzoom" + g;
    f.style.width = "66px";
    f.style.height = "90px";
    h.appendChild(f);
    f = document.createElement("img");
    f.src = jmyd.dataLocale + "helpmove" + g;
    f.style.width = "66px";
    f.style.height = "90px";
    h.appendChild(f);
    f = document.createElement("img");
    f.src = jmyd.dataLocale + "ctrlhelpreset" + g;
    f.style.width = "66px";
    f.style.height = "90px";
    h.appendChild(f);
    f = document.createElement("img");
    f.src = jmyd.dataLocale + "helplights" + g;
    f.style.position = "relative";
    d || (f.style.left = "8px");
    f.style.width = "66px";
    f.style.height = "90px";
    ...
    h.appendChild(g);
    f = document.createElement("img");
    f.src = jmyd.dataLocale + "logo2.png";
    f.style.position = "absolute";
    ...
    this.menuCluster.style.right = jmyd.largeUI ? "4px" : "0px";
    this.menuCluster.style.top = jmyd.largeUI ? "20px" : "10px";
    jmyd.largeUI ? (this.menuCluster.style.width = "72px", this.menuCluster.style.height = "64px") : (this.menuCluster.style.width = "36px", this.menuCluster.style.height = "36px");
    h = document.createElement("div");
    ...
    void(0) !== jmyd.hostImage && (jmyd.hostURL && (g = document.createElement("a"), g.href = jmyd.hostURL, g.target = "_blank"), f = document.createElement("img"), f.src = jmyd.hostImage, f.style.position = "absolute", f.style.top = "4px", f.style.left = "4px", f.style.opacity = 0.65, f.style["-webkit-transform"] = f.style.transform = "translate(-50%,-50%) scale(0.5,0.5) translate(50%,50%)", jmyd.hostURL ? (f.onmouseover = function() {
    ...
    jmyd.showFrameTime && (this.frameTimer = document.createElement("text"), this.frameTimer.style.position = "absolute", this.frameTimer.style.left = this.frameTimer.style.top = "5px", this.frameTimer.style.color = "gray", this.frameTimer.style.fontSize = "75%", this.container.appendChild(this.frameTimer), this.frameTimer.innerHTML = "--", this.frameCount = 1E20)
  }
  ...
  UI.prototype.signalLoadProgress = function(a, b, w) {
  ...
  Vect.set = function(a, b, c, d, e) {
    a[0] = b;
    a[1] = c;
    a[2] = d;
    a[3] = e
  }
  Vect.copy = function(a, b) {
    a[0] = b[0];
    a[1] = b[1];
    a[2] = b[2];
    a[3] = b[3]
  }
  Vect.add = function(a, b, c) {
    a[0] = b[0] + c[0];
    a[1] = b[1] + c[1];
    a[2] = b[2] + c[2];
    a[3] = b[3] + c[3];
  ...
  Vect.negate = function(a, b) {
    a[0] = -b[0];
    a[1] = -b[1];
    a[2] = -b[2];
    return a
  }
  Vect.negate4 = function(a, b) {
    a[0] = -b[0];
    a[1] = -b[1];
    a[2] = -b[2];
    a[3] = -b[3];
  ...
  Vect.dot4 = function(a, b) {
    return a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3]
  }
  Vect.normalize = function(a, b) {
    var c = b[0],
      d = b[1],
      e = b[2],
  ...
  Vect.projectOnPlane = function(a, b, c, d) {
    var e = Vect.empty();
    Vect.sub(e, b, c);
    c = Vect.dot(e, d);
    smad(a, -c, normal, b);
  ...
  Previewer.prototype.initGL = function() {
    var a = {
      alpha: !!jmyd.transparentBackground,
      depth: !1,
      stencil: !1,
      antialias: !1,
      premultipliedAlpha: !!jmyd.transparentBackground,
  ...
  jmyd.WebViewer = WebViewer = function(a, b, c, d) {
  ...
  WebViewer.prototype.start = function() {
    if (jmyd.edit) {
      ...
      gui.matListInit(m);
      gui.bindEvents();
      console.log("loadTime: " + (new Date().getTime() - jmyd.startTime) + "ms")
    };
  ...
  WebViewer.prototype.drawScene4times = function() {
    this.updateView()
  }
  ...
  WebViewer.prototype.drawScene2 = function() {
    if (this.gl.isContextLost()) {
      return
    };
    this.scene.view.updateProjection();
  ...
  "use strict";
  prepareEmbedParams = prepareEmbedParams, embed = embed, fetchThumbnail = fetchThumbnail, jmyd = "undefined" == typeof jmyd ? {} : jmyd;
  jmyd.embed = embed;
  jmyd.fetchThumbnail = fetchThumbnail;
  
  
  
  
  ArchiveSky.prototype.decompress = Archive.prototype.decompress;
  jmyd = "undefined" == typeof jmyd ? {} : jmyd;
  jmyd.dataLocale = "images/";
  ShaderTable = {
